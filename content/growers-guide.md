...
The timing stays the same. A longer veg simply gives you more cycles.
...
**Shake well.** Both products are ready to use. Do not dilute.

**Less is more.** Apply a light, even spray until the foliage is lightly damp—not to runoff. Full top-and-bottom leaf coverage is not required.

**Time it to the environment.** Outdoors, spray in the early morning or late afternoon. Indoors, spray at lights-off.

**Perpetual rooms:** Treat by batch, not by room. Count from each batch's transplant date.

**Keep the rest of your program the same.** There is no need to change your base nutrients, EC, irrigation strategy, dryback targets or defoliation schedule.

**Apply alone.** Do not combine either product with other products in the same sprayer. There is no required waiting period before or after separately applied foliar sprays, including pesticides.

---

## Why the cadence matters

Ready-to-use bottles keep the application consistent between operators and batches. There are no scales, dilution ratios or mixing calls. Whoever has the sprayer can run the same application the same way.
...
Coverage depends on plant size and sprayer output. Run one representative batch, note how many plants a bottle covers and use that number for future orders. Later applications may use more product because the plants are larger.

## Storage and handling

Store cool and out of direct light. Keep bottles upright and tightly closed. Lock the sprayer trigger when it is not in use.
...
**Half my batch was transplanted Monday and half Thursday.**  
Treat them as two batches and count from each transplant date. Do not combine the spray days just to make the calendar easier.

**Can I combine it with another product in the same sprayer?**  
No. Spray each product on its own. There is no required waiting period before or after other foliar sprays, including pesticides.

---

## What it is not for

- **Cuttings still under a dome:** Wait until they are out of the dome and moving water on their own.
- **Flowering plants:** This program is for veg, not flower.
- **Rescue treatment:** It will not correct problems with the environment, irrigation, pests or nutrition.

---

*For use on legally cultivated crops in accordance with all applicable state and local regulations. Not a pesticide, fungicide or plant growth regulator. Keep out of reach of children.*
